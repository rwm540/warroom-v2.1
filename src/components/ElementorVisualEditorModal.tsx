      ...
      case 'action_buttons':
        return (
          <div className="bg-slate-950/60 p-4 rounded-2xl border border-slate-800 text-center space-y-2">
            <span className="text-xs font-bold text-slate-400 block">نوار کلیدهای تعاملی و دسترسی‌های سریع (تنظیم شده در CMS)</span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xs sm:text-sm font-black text-white flex items-center gap-2">
              <span>طراح دیداری المنتور صفحه اصلی (Elementor Live Page Builder)</span>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-white group-hover:text-cyan-300">سوالات متداول (FAQ)</h4>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400">کانال‌های بله، ایتا و تلگرام</p>
                    </div>
                  </button>
                ...
                {selectedBlock ? (
                  <div className="space-y-3 bg-slate-950 p-3.5 rounded-2xl border border-slate-800">
                    ...
                    {selectedBlock.type === 'video_player' && (
                      <div className="space-y-1">
                        <label className="text-[11px] font-bold text-slate-400 block">آدرس مستقیم فایل ویدئو (URL):</label>
                        <input
                          type="text"
