...
import { X, Award, User as UserIcon, Check, ShieldCheck, Sparkles, Star } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 dir-rtl">
      <motion.div 
        ...
        className="bg-[#080d21] border border-cyan-500/30 rounded-2xl max-w-lg w-full p-6 space-y-6 shadow-2xl overflow-hidden relative"
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-black text-white">پروفایل رزمنده و انتخاب آواتار</h2>
              <p className="text-xs text-slate-400 font-medium">اطلاعات شناسنامه، سطح و انتخاب آواتار تاکتیکی</p>
            </div>
          </div>
          <button 
            onClick={onClose}
