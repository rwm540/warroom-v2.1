  ...
  const stages: JourneyStage[] = [
    {
      ...
      iconName: 'flag',
      requiredPoints: 0,
      description: 'گام نخست حضور در کاروان و حرکت در مسیر نورانی. در این مرحله رزمنده ثبت‌نام خود را قطعی کرده و با مرام‌نامه و اهداف پویش آشنا می‌شود.',
      missionsCount: 2,
      completedMissions: 2,
    ...
    },
    {
      ...
      number: 4,
      title: 'خدمت',
      subtitle: 'پویش‌های امدادی و بسته‌های کمک مؤمنانه',
      status: 'in_progress',
      iconName: 'service',
      requiredPoints: 1400,
      description: 'مشارکت در خدمت‌رسانی به نیازمندان، توزیع ارزاق و اجرای پویش‌های خیرخواهانه جهادی.',
      missionsCount: 4,
      completedMissions: 1,
